var D=Object.defineProperty;var N=(i,t,a)=>t in i?D(i,t,{enumerable:!0,configurable:!0,writable:!0,value:a}):i[t]=a;var o=(i,t,a)=>(N(i,typeof t!="symbol"?t+"":t,a),a);import{m as L,c as C,a as I}from"./index-c024f136.js";import{AnnularWedgeGL as ne}from"./annular_wedge-6179618b.js";import{AnnulusGL as _e}from"./annulus-4d29b7ef.js";import{B as oe}from"./base_line-94d028b8.js";import{B as le}from"./base_marker-6ec88d4f.js";import{CircleGL as de}from"./circle-aac8f969.js";import{HexTileGL as he}from"./hex_tile-b44e0e0b.js";import{ImageGL as ue}from"./image-cff1c78a.js";import{LineGL as pe}from"./line_gl-3a95e2c1.js";import{LRTBGL as xe}from"./lrtb-8966e156.js";import{MultiLineGL as ye}from"./multi_line-5aabaf07.js";import{MultiMarkerGL as Se}from"./multi_marker-c2929f90.js";import{RectGL as Re}from"./rect-c9a6f365.js";import{S as Ae}from"./single_line-2fabcd21.js";import{S as Ue}from"./single_marker-b524e8da.js";import{StepGL as De}from"./step-1ef5c37b.js";import{WedgeGL as Le}from"./wedge-838192cd.js";import"https://esm.sh/ethers@6.13.2";import"./sxsy-dee08ce4.js";import"./buffer-ba52107b.js";function k(i,t){let a,_;i>t?(a=i,_=t):(a=t,_=i);let n=a%_;for(;n!=0;)a=_,_=n,n=a%_;return _}function w(i){let t=i[0];for(let a=1;a<i.length;a++)t=k(t,i[a]);return t}function O(i){return(i&i-1)==0&&i!=0}class S{constructor(t){o(this,"_regl");o(this,"_map");this._regl=t,this._map=new Map}_create_texture(t){const a=t.length;let _=0;const n=[];let e=0,c=0;for(let l=0;l<a;l++)_+=t[l],n.push(t[l]+t[(l+1)%a]),l%2==0?c=Math.max(c,t[l]):e=Math.min(e,-t[l]);e*=.5,c*=.5;const f=w(n),s=[0];for(let l=0;l<a;l++)s.push(s[l]+t[l]);const r=2*_/f,m=O(r),u=m?r:128,h=.5*f*r/u;let d;if(m){if(d=.5*t[0],h<d){const l=Math.floor(d/h);d-=l*h}}else d=0;const j=d-.5*h,x=new Uint8Array(u);let v=0;for(let l=0;l<u;l++){const b=d+l*h;b>s[v+1]&&v++;const y=t[v],T=s[v]+.5*y;let g=.5*y-Math.abs(b-T);v%2==1&&(g=-g),x[l]=Math.round(255*(g-e)/(c-e))}const U=this._regl.texture({shape:[u,1,1],data:x,wrapS:"repeat",format:"alpha",type:"uint8",mag:"linear",min:"linear"});return[[_,j,e,c],U]}_get_key(t){return t.join(",")}_get_or_create(t){const a=this._get_key(t);let _=this._map.get(a);if(_==null){const n=w(t);if(n>1){t=L(t,s=>s/n),_=this._get_or_create(t);const[e,c,f]=_;_=[e,c,n],this._map.set(a,_)}else{const[e,c]=this._create_texture(t);_=[e,c,n],this._map.set(a,_)}}return _}get(t){return t.length%2==1&&(t=C([t,t])),this._get_or_create(t)}}o(S,"__name__","DashCache");const P=`
