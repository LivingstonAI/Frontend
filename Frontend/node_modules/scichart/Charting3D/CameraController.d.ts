...
export interface ICameraOptions {
    ...
    farClip?: number;
    /**
     * The {@link ECameraProjectionMode}.
     *
     * Default {@link ECameraProjectionMode.Perspective}
     */
    projectionMode?: ECameraProjectionMode;
    /**
     * The orthogonal viewable width in world coordinates
     * @remark Only works when `projectionMode` is set to `ECameraProjectionMode.Orthogonal`
     *
     * Default `600`
     */
    orthoWidth?: number;
