...
export interface IColumnRenderableSeries3DOptions extends IBaseRenderableSeries3DOptions {
    /**
     * A point marker {@link BaseMeshPointMarker3D |3D Point Marker} which is used to draw columns at each Xyz data-point.
     */
    pointMarker?: BaseMeshPointMarker3D | TPointMarkerDefinition3D;
    /**
...
export declare class ColumnRenderableSeries3D extends BaseRenderableSeries3D {
     ...
     * @param options Optional parameters of type {@link IColumnRenderableSeries3DOptions} to configure the series
     */
    constructor(webAssemblyContext: TSciChart3D, options?: IColumnRenderableSeries3DOptions);
    /** @inheritDoc */
    ...
    protected getOptions(): IColumnRenderableSeries3DOptions;
}
