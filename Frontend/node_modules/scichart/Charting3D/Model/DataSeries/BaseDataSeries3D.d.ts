import { TDataSeriesDefinition3D } from "../../../Builder/buildDataSeries";
...
export declare abstract class BaseDataSeries3D extends DeletableEntity implements IDataSeries3D {
    ...
    resetModified(): void;
    /** @inheritDoc */
    toJSON(excludeData?: boolean): TDataSeriesDefinition3D;
    protected getOptions(excludeData: boolean): IBaseDataSeries3DOptions;
}
