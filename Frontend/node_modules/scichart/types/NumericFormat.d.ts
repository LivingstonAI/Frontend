...
export declare enum ENumericFormat {
     ...
     *
     * @note `labelPrecision` will not only represent the number of decimal places, but the number of significant figures, when needed.
     */
...
export interface IEngineeringPrefix {
    /**
     * Defines the **supunitary** prefixes for the Engineering format
     * Default `["K", "M", "B", "T"]` - standing for Kilo, Mega, Giga, Tera
     */
    large?: string[];
    /**
     * Defines the **subunitary** prefixes for the Engineering format
     * Default `["m", "u", "n", "p"]` - standing for milli, micro, nano, pico
     */
    small?: string[];
}
