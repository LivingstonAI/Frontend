...
var NumericCoordinateCalculator = /** @class */ (function (_super) {
     ...
     */
    function NumericCoordinateCalculator(webAssemblyContext, viewportDimension, visibleMin, visibleMax, offset, allowFastMath, viewportOffset, extraOffset) {
        if (offset === void 0) { offset = 0; }
        if (allowFastMath === void 0) { allowFastMath = false; }
        if (viewportOffset === void 0) { viewportOffset = -1; }
        ...
        //     extraOffset
        // );
        var cc = allowFastMath
            ? new webAssemblyContext.LinearCoordinateCalculatorSingle(_this.viewportDimension, _this.visibleMin, _this.visibleMax, viewportOffset, _this.offset)
            : new webAssemblyContext.LinearCoordinateCalculatorDouble(_this.viewportDimension, _this.visibleMin, _this.visibleMax, viewportOffset, _this.offset);
        cc.extraOffset = extraOffset;
        _this.nativeCalculator = cc;
        return _this;
    }
