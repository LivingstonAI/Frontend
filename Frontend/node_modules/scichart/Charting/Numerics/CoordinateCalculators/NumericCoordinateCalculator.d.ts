...
export declare class NumericCoordinateCalculator extends CoordinateCalculatorBase {
     ...
     */
    constructor(webAssemblyContext: TSciChart | TSciChart3D, viewportDimension: number, visibleMin: number, visibleMax: number, offset?: number, allowFastMath?: boolean, viewportOffset?: number, extraOffset?: number);
}
