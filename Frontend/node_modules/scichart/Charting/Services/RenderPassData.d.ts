...
export declare class RenderPassData {
    readonly indexRange: NumberRange | undefined;
     ...
     */
    constructor(indexRange: NumberRange | undefined, getxCoordinateCalculator: () => CoordinateCalculatorBase, getyCoordinateCalculator: () => CoordinateCalculatorBase, isVerticalChart: boolean, pointSeries?: IPointSeries, resamplingHash?: number);
    /**
