...
export declare class TitleRendererBase<TextStyleType extends TAxisTitleStyle | TChartTitleStyle> extends DeletableEntity implements ITitleRenderer {
     ...
     */
    protected drawInternal(renderContext: WebGlRenderContext2D, useNativeText: boolean, titlePosition: ETitlePosition, clipRect: Rect): void;
    protected drawWithNativeText(renderContext: WebGlRenderContext2D, position: ETitlePosition, clipRect: Rect): void;
    protected drawWithTexture(renderContext: WebGlRenderContext2D, titlePosition: ETitlePosition, clipRect: Rect): void;
    /**
