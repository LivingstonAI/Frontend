...
var HlcSeriesInfo = /** @class */ (function (_super) {
    ...
    HlcSeriesInfo.prototype.getValuesWithLabels = function (title, xLabel, yLabel, isXYGrouped) {
        ...
        res.push(this.concatValueWithLabel(this.formattedHighValue, "High"));
        res.push(this.concatValueWithLabel(this.formattedLowValue, "Low"));
        return res;
    };
