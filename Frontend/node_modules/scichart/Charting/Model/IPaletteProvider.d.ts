...
export interface IStrokePaletteProvider extends IPaletteProvider {
     ...
     */
    overrideStrokeArgb(xValue: number, yValue: number, index: number, opacity?: number, metadata?: IPointMetadata): number | undefined;
}
...
export interface IFillPaletteProvider extends IPaletteProvider {
     ...
     * @returns an ARGB color code, e.g. 0xFFFF0000 would be red, or 'undefined' for default colouring
     */
    overrideFillArgb(xValue: number, yValue: number, index: number, opacity?: number, metadata?: IPointMetadata): number | undefined;
}
...
export interface IPointMarkerPaletteProvider extends IPaletteProvider {
     ...
     */
    overridePointMarkerArgb(xValue: number, yValue: number, index: number, opacity?: number, metadata?: IPointMetadata): TPointMarkerArgb | undefined;
}
/**
