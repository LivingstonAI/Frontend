...
var BottomAlignedInnerAxisLayoutStrategy = /** @class */ (function (_super) {
    ...
    BottomAlignedInnerAxisLayoutStrategy.prototype.updateAreaSize = function (chartLayoutState, requiredSize) {
        chartLayoutState.bottomInnerAreaSize = requiredSize;
    };
    BottomAlignedInnerAxisLayoutStrategy.prototype.layoutAxes = function (left, top, right, bottom, axes) {
        ...
        if (this.axisPosition !== undefined) {
            var verticalAxis = (_a = this.sciChartSurface.getYAxisById(this.orthogonalAxisId)) !== null && _a !== void 0 ? _a : this.sciChartSurface.getDefaultYAxis();
