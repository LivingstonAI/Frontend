...
export declare abstract class BaseAxisLayoutStrategy {
     ...
     * For vertical axes - total required width of the area, for horizontal - total required height.
     * @param sciChartSurface
     * @param chartLayoutState
     * @param axes
     */
    abstract measureAxes(sciChartSurface: SciChartSurface, chartLayoutState: ChartLayoutState, axes: AxisBase2D[]): number;
    /**
     * Updates chart layout state accordingly to axes required space in axisSize dimension.
     * Updates different areas based on strategy type.
     * @param sciChartSurface
     * @param chartLayoutState
     */
    abstract updateAreaSize(chartLayoutState: ChartLayoutState, requiredSize: number): void;
    /**
