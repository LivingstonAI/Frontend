...
var LeftAlignedInnerAxisLayoutStrategy = /** @class */ (function (_super) {
    ...
    LeftAlignedInnerAxisLayoutStrategy.prototype.updateAreaSize = function (chartLayoutState, requiredSize) {
        chartLayoutState.leftInnerAreaSize = requiredSize;
    };
    LeftAlignedInnerAxisLayoutStrategy.prototype.layoutAxes = function (left, top, right, bottom, axes) {
        ...
        if (this.axisPosition !== undefined) {
            var horizontalAxis = (_a = this.sciChartSurface.getXAxisById(this.orthogonalAxisId)) !== null && _a !== void 0 ? _a : this.sciChartSurface.getDefaultXAxis();
