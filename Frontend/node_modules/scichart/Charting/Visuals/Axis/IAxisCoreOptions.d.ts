...
export interface IAxisCoreOptions {
     ...
     * @description
     * By default all axes in SciChart have unique autogenerated IDs. However sometimes it is handy to set your own ID which is possible at construction time.
     * If you set the Id manually make sure it is unique
     *
