...
export declare abstract class AxisBase2D extends AxisCore implements IThemeable {
    ...
    abstract type: EAxisType.CategoryAxis | EAxisType.LogarithmicAxis | EAxisType.NumericAxis | EAxisType.DateTimeNumericAxis | EAxisType.PolarNumericAxis | EAxisType.PolarCategoryAxis;
    /**
    ...
    protected penCacheForMajorGridLines: Pen2DCache;
    protected penCacheForMinorGridLines: Pen2DCache;
    private penCacheForMajorTickLines;
    private penCacheForMinorTickLines;
    protected solidBrushCacheAxisBands: SolidBrushCache;
    protected solidBrushCacheAxisBackground: SolidBrushCache;
    private axisBorderProperty;
    protected solidBrushCacheBorder: SolidBrushCache;
    protected axisLengthProperty: number;
    protected offsetProperty: number;
    protected offsetOverrideProperty: number;
    private tickCache;
    ...
    getVisibleRenderableSeriesByXAxis(): IRenderableSeries[];
    getVisibleRenderableSeriesByYAxis(): IRenderableSeries[];
    /**
     * @inheritDoc
     */
    delete(): void;
    toJSON(): TAxisDefinition;
    protected createAxisRender(): AxisRenderer;
    /**
    ...
    protected getXVisibleRange(xAxisId: string | undefined): NumberRange;
    protected getIsXCategoryAxis(xAxisId: string | undefined): boolean;
    /**
     ...
     */
    protected removeLinksToAxis(): void;
    getAxisSize(): number;
    private getMajorTickIndex;
    private getTicks;
    protected getTicksWithCoords(): TTickObject;
