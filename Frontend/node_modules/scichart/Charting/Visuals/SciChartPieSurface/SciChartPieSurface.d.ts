...
export declare class SciChartPieSurface extends DeletableEntity implements ISciChartSurfaceBase {
    ...
    readonly domBackgroundSvgContainer: SVGSVGElement;
    ...
    set mouseManager(v: MouseManager);
    /**
     * domCanvasWebGL property is not supported for SciChartPieSurface
     */
    get domCanvasWebGL(): HTMLCanvasElement;
    set domCanvasWebGL(v: HTMLCanvasElement);
    /**
     ...
     */
    get annotations(): ObservableArray<IAnnotation>;
    /**
     * chartModifiers property is not supported for SciChartPieSurface
     */
    get chartModifiers(): ObservableArray<IChartModifierBase>;
    /**
    ...
    protected getOptions(): Omit<Required<Omit<IPieSurfaceOptions, never>>, "loader">;
    /**
