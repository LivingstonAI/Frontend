...
import { SciChartPolarSurface } from "./SciChartPolarSurface";
 ...
 */
export declare class SciChartPolarSubSurface extends SciChartPolarSurface implements ISciChartSubSurface {
    static createSubSurface(parentSurface: ISciChartSurface, options?: I2DSubSurfaceOptions): SciChartPolarSubSurface;
     ...
     * @inheritDoc
     */
    protected applySciChartBackground(background: string, renderContext2D: WebGlRenderContext2D): void;
