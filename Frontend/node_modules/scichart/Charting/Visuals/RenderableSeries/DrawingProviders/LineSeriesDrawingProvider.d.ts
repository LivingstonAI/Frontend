import { SCRTDoubleVector, SCRTLineDrawingParams, TSciChart } from "../../../../types/TSciChart";
 ...
 */
export declare class LineSeriesDrawingProvider extends BaseSeriesDrawingProvider<ILineRenderableSeries> {
     ...
     */
    constructor(webAssemblyContext: TSciChart, parentSeries: ILineRenderableSeries, ySelector?: (ps: IPointSeries) => SCRTDoubleVector, xSelector?: (ps: IPointSeries) => SCRTDoubleVector);
    /**
     * @inheritDoc
     */
    ...
    getProperties(parentSeries: ILineRenderableSeries): ILineSeriesDrawingProviderProperties;
    /**
     * @inheritDoc
     */
    onAttachSeries(): void;
