 ...
 */
declare function hitTestForBoxUnsorted(xCoordinateCalculator: CoordinateCalculatorBase, yCoordinateCalculator: CoordinateCalculatorBase, xValues: SCRTDoubleVector, x1Values: SCRTDoubleVector | undefined, yValues: SCRTDoubleVector, y1Values: SCRTDoubleVector | undefined, xHitCoord: number, yHitCoord: number, defaultY1: number, columnCoordWidth: number, columnXMode: EColumnMode, columnYMode: EColumnYMode, isVertical: boolean, isPolar: boolean): TRectangleSeriesHitTestResult;
/**
