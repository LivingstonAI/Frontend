...
export interface ILineRenderableSeries extends IRenderableSeries {
    strokeDashArray: number[];
    lineType: ELineType;
}
export declare abstract class BaseLineRenderableSeries extends BaseRenderableSeries implements ILineRenderableSeries {
