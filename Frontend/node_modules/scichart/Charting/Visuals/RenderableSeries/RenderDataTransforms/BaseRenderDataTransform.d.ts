...
import { XyzPointSeriesResampled } from "../../../Model/PointSeries/XyzPointSeriesResampled";
 ...
 * You must extend this and override runTransformInternal or it will throw an error
 */
export declare class XyzBaseRenderDataTransform extends BaseRenderDataTransform<XyzPointSeriesResampled> {
    protected createPointSeries(): XyzPointSeriesResampled;
    protected runTransformInternal(renderPassData: RenderPassData): IPointSeries;
}
