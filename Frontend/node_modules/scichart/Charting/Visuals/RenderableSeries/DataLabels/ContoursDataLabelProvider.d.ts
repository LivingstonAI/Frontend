...
import { IContourDrawingParams } from "../UniformContoursRenderableSeries";
...
export declare class ContoursDataLabelProvider extends BaseDataLabelProvider {
    ...
    makeContourLabels(contourParams: IContourDrawingParams, yStart: number, yStep: number, renderPassData: RenderPassData, xStart: number, xStep: number, font: SCRTFont, bounds: TSRTextBounds): void;
    toJSON(): {
