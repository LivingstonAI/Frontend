...
export declare abstract class RenderContextAnnotationBase extends AnnotationBase {
     ...
     */
    abstract drawWithContext(renderContext: IRenderContext2D, xCalc: CoordinateCalculatorBase, yCalc: CoordinateCalculatorBase, seriesViewRect: Rect, surfaceViewRect: Rect, chartViewRect: Rect): void;
}
