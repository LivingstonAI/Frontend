...
exports.SciChart3DLegend = void 0;
 ...
 */
var SciChart3DLegend = /** @class */ (function (_super) {
    __extends(SciChart3DLegend, _super);
    function SciChart3DLegend() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = SciChartLegendBase_1.ELegendType.SciChart3DLegend;
        _this.showCheckboxesProperty = false;
        _this.showSeriesMarkersProperty = true;
        return _this;
    }
    /** @inheritDoc */
    SciChart3DLegend.prototype.applyTheme = function () {
        // TODO: add light theme
    };
    Object.defineProperty(SciChart3DLegend.prototype, "showCheckboxes", {
        /**
    ...
    Object.defineProperty(SciChart3DLegend.prototype, "showSeriesMarkers", {
        /**
     ...
     */
    SciChart3DLegend.prototype.setRenderableSeriesArray = function (renderableSeriesArray) {
        this.renderableSeriesArray = renderableSeriesArray;
        this.invalidateLegend();
    };
    /** @inheritDoc */
    SciChart3DLegend.prototype.addEventListeners = function () {
        var _this = this;
        this.renderableSeriesArray.forEach(function (rs) { return _this.addEventListenerToSeries(rs); });
    };
    /** @inheritDoc */
    SciChart3DLegend.prototype.removeEventListeners = function () {
        var _this = this;
     ...
     */
    SciChart3DLegend.prototype.addEventListenerToSeries = function (rs) {
        var _this = this;
    ...
    /** @inheritDoc */
    SciChart3DLegend.prototype.getInnerHTML = function () {
        ...
        var legendItems = this.renderableSeriesArray.map(function (rs, index) {
            ...
            return ({
                id: rs.id,
                name: (_a = rs.seriesName) !== null && _a !== void 0 ? _a : "Series ".concat(index + 1),
                color: rs.stroke,
    ...
    return SciChart3DLegend;
}(SciChartLegendBase_1.SciChartLegendBase));
exports.SciChart3DLegend = SciChart3DLegend;
