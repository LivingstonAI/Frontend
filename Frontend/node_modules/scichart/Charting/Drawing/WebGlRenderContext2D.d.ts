...
import { SCRTBrush, SCRTPen, SCRTRenderContext, TSciChart, VectorArcVertex, VectorColorVertex, VectorRectVertex } from "../../types/TSciChart";
 ...
 */
export declare const calculateAbsoluteRenderLayer: (surfaceOrder: number, layerStep: number, relativeRenderLayer: number | EDefaultRenderLayer) => number;
/**
...
export declare class WebGlRenderContext2D extends DeletableEntity implements IRenderContext2D {
     ...
     */
    drawLinesNative(vertices: VectorColorVertex, pen: SCRTPen, lineDrawMode: ELineDrawMode, clipRect: Rect, left?: number, top?: number): void;
    /**
     ...
     * @param top - offset in pixels from top, typically used for axes
     */
    drawRects(vertices: VectorRectVertex, brush: SCRTBrush, clipRect: Rect, left?: number, top?: number): void;
    drawEllipses(vertices: VectorRectVertex, pen: SCRTPen, left?: number, top?: number): void;
    drawArcs(vertices: VectorArcVertex, xCenter: number, yCenter: number, rotation: number, clipRect: Rect, pen: SCRTPen, brush?: SCRTBrush, left?: number, top?: number): void;
    /**
     ...
     * @inheritDoc
     */
    drawLine(x1: number, y1: number, x2: number, y2: number, pen: IPen2D, viewRect: Rect, clipRect: Rect): void;
    /**
     * @inheritDoc
     */
    drawLines(xyValues: number[], strokePen: IPen2D, viewRect: Rect, clipRect: Rect, lineDrawMode?: ELineDrawMode): void;
    /**
     * @inheritDoc
     */
    drawTriangleStrip(xValues: number[], yValues: number[], viewRect: Rect, clipRect: Rect, fillBrush?: IBrush2D): void;
    /**
     * @inheritDoc
     */
    drawRect(rect: Rect, viewRect: Rect, clipRect: Rect, strokePen?: IPen2D, fillBrush?: IBrush2D, bevelCorners?: boolean, strokeThickness?: number, rotation?: number): void;
    ...
    EnsureContextTransform(xOffset: number, yOffset: number, clipRect: Rect, rotation?: number): number;
    EnsureMatrixTransform(param0: number, param1: number, param2: number): number;
}
export {};
