...
export interface IRenderContext2D extends IDeletable {
     ...
     */
    drawLine(x1: number, y1: number, x2: number, y2: number, strokePen: IPen2D, viewRect: Rect, clipRect: Rect): void;
    /**
    ...
    /**
     * @description Draws a triangle strip with the specified Pen
     * @param xValues An array of x coordinates
     * @param yValues An array of y coordinates
     * @param viewRect The series viewRect, used for translate
     * @param clipRect The rect, used for clipping
     ...
     * @param fillBrush the fill brush to draw the fill with
     */
    drawRect(rect: Rect, viewRect: Rect, clipRect: Rect, strokePen?: IPen2D, fillBrush?: IBrush2D, bevelCorners?: boolean, strokeThickness?: number): void;
}
