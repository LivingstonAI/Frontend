 ...
 * @description Applied to a 2D {@link SciChartSurface}, or a 3D {@link SciChart3DSurface}, the ThemeProvider may be
...
export declare abstract class ThemeProvider implements IThemeProvider {
    ...
    abstract annotationsGripsBackgroundBrush: string;
    annotationSelectionStroke?: string;
