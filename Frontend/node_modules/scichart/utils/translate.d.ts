...
export declare const translateToScaled: (value: number) => number;
export declare const translateToNotScaled: (value: number) => number;
export declare const translateToScaledRect: (rect: Rect) => Rect;
export declare const translateToNotScaledRect: (rect: Rect) => Rect;
