...
export default function SnowAILandingPage() {
  ...
  const songs = {
    "1": { name: "Atreides Theme ⚔️", file: atreides_theme },
    "2": { name: "Jingle Bells", file: jingleBells },
    "3": { name: "Snow Storm", file: snowStorm },
    "4": { name: "Love Story", file: love_story },
    "5": { name: "Ezio's Family", file: ezio_family },
    "6": { name: "Hymn for The Weekend", file: hymn_for_the_weekend },
    "7": { name: "Daydreaming", file: daydreaming },
    "8": { name: "Me Times Two", file: me_times_two},
    "9": { name: "We Don't Talk Anymore", file: we_dont_talk_anymore },
    "10": { name: "Should I Stay or Should I Go", file: should_i_stay },
    "11": { name: "The Middle", file: the_middle },
    "12": { name: "Quiet Night", file: quiet_night },
    "13": { name: "Feels", file: feels },
    "14": { name: "I'm Good (Blue)", file: im_good },
    "15": { name: "Never Give Up", file: never_give_up },
    "16": { name: "Gravity", file: gravity },
    "17": { name: "Closer", file: closer },
    "18": { name: "Bloody Mary (Edit)", file: bloody_mary_edit },
    "19": { name: "Waiting 💙", file: waiting },
    "20": { name: "Wish (Wonderland) ✨🎸", file: wish_wonderland },
    "21": { name: "Welcome to Columbia!📖🚀", file: welcome_to_columbia },
    "22": { name: "沉溺（你让我的心不再结冰) 🎶🌆", file: 沉溺 },
    "23": { name: "Shoot to Thrill - ACDC 🤖🎸", file: shoot_to_thrill },
    "24": { name: "When I'm With You - Arcando", file: when_im_with_you },
    "25": { name: "Coffee Time ☕", file: coffee_time },
    "26": { name: "Coffee Lounge ☕", file: coffee_lounge },
    ...
    "34": { name: "Lemon Cake 🍋🍰", file: lemon_cake },
    "35": { name: "Marshmellow 😋", file: marshmellow},
    "36": { name: "Rose 🌹", file: rose},
    "37": { name: "This is MIT 👨‍🎓📚", file: this_is_mit },
    "38": { name: "Dune: Time between storms ⌛🗡️", file: time_between_storms },
    "39": { name: "Somnus Theme 🐺🥷", file: somnus_theme },
    "40": { name: "Joji - Your Man 🦸‍♂️🦸‍♀️", file: your_man },
    "41": { name: "Cry Baby - SZA 🌃🌃", file: cry_baby },
    "42": { name: "Genesis - Jorma Kaukonen 🧑🏾‍🤝‍👩🏼👨‍💻👩‍💻", file: genesis },
    "43": { name: "Rewrite the Stars 🌃", file: rewrite_the_stars },
    ...
    "48": { name: "MIT Hall That Never Ends 👨‍🎓🎶", file: mit_hall },
  };
