...
//     const dayArray = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun', 'Day'];
...
//             try {
//                 const response = await fetch(`http://127.0.0.1:8000/upcoming_news/${userEmail}/`);
//                 const data = await response.json();
//                 console.log(data);  // Print news data from JsonResponse
//                 setNewsData(data);  // Update the news data state
//             } catch (error) {
...
//                         </thead>
//                         <tbody>
//                             {/* Possibly adding a try catch here? */}
//                             {newsData &&
