...
export default function GoogleCalendar() {
    ...
    const downloadMonthlyReport = async () => {
        ...
        try {
            ...
            // Add account name below the date - NEW ADDITION
            pdf.setFontSize(14);
            ...
            Object.entries(dayMetrics).forEach(([day, metrics]) => {
                checkNewPage(8);
                // Updated colors - darker green and red for better visibility
                const color = metrics.total >= 0 ? [21, 128, 61] : [185, 28, 28]; // Darker green and red
            ...
            if (monthTrades.length > 0) {
                ...
                sortedWeeks.forEach(weekStart => {
                    ...
                    weekTrades.forEach(trade => {
                        ...
                        // Set color based on profit/loss - Updated colors for better visibility
                        if (trade.amount > 0) {
